          ...
          return (
            ...
            t.each(['my', 'at'], function() {
              ...
              1 === i.length &&
                (i = r.test(i[0])
                  ? i.concat(['center'])
                  : l.test(i[0]) ? ['center'].concat(i) : ['center', 'center']),
    ...
    _optionDatepicker: function(e, i, s) {
      ...
      return 2 === arguments.length && 'string' == typeof i
        ? 'defaults' === i
          ...
          : h
            ? 'all' === i ? t.extend({}, h.settings) : this._get(h, i)
            : null
        : ((n = i || {}),
        ...
        t.fn.extend({
          effect: function() {
            function i(e) {
              ...
              (s.mode = c.shift()),
                t.uiBackCompat === !1 || o
                  ? 'none' === s.mode ? (r[h](), a()) : n.call(r[0], s, i)
